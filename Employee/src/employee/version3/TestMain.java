...
public class TestMain {
    public static void main(String[] args) {
        ...
        HourlyEmployee HourEmp2 = new HourlyEmployee(22104404, nameEmp2, dateHired, dateBirth);
        HourEmp2.setTotalHoursWorked(60);
        HourEmp2.setRatePerHour(400);

        HourlyEmployee HourEmp3 = new HourlyEmployee(22104405, nameEmp3, dateHired, dateBirth, 40, 250);
        ...
        PieceWorkEmp1.setEmpName(nameEmp1);
        ...
        PieceWorkerEmployee PieceWorkEmp2 = new PieceWorkerEmployee(22104404, nameEmp2, dateHired, dateBirth);
        PieceWorkEmp2.setTotalPiecesFinished(555);
        PieceWorkEmp2.setRatePerPiece(50);

        PieceWorkerEmployee PieceWorkEmp3 = new PieceWorkerEmployee(22104405, nameEmp3, dateHired, dateBirth, 350, 60);
        ...
        CommissionEmp1.setEmpName(nameEmp1);
        CommissionEmp1.setEmpDateHired(dateHired);
        CommissionEmp1.setEmpBirthDate(dateBirth);
        CommissionEmp1.setTotalSales(35000);

        CommissionEmployee CommissionEmp2 = new CommissionEmployee(22104404, nameEmp2, dateHired, dateBirth);
        CommissionEmp2.setTotalSales(40000);

        CommissionEmployee CommissionEmp3 = new CommissionEmployee(22104405, nameEmp3, dateHired, dateBirth, 60000);
        ...
        BasePlusCommissionEmp1.setEmpName(nameEmp1);
        ...
        BasePlusCommissionEmployee BasePlusCommissionEmp2 = new BasePlusCommissionEmployee(22104404, nameEmp2, dateHired, dateBirth);
        BasePlusCommissionEmp2.setTotalSales(60000);
        BasePlusCommissionEmp2.setBaseSalary(40000);

        BasePlusCommissionEmployee BasePlusCommissionEmp3 = new BasePlusCommissionEmployee(22104405, nameEmp3, dateHired, dateBirth, 550000, 50000);
